            ...
            <section className="messages-section my-5">
              ...
              <section className="message-area">
                ...
                <section className="all-messages my-5">
                  <section className="message-one flex items-center gap-x-3 my-4 cursor-pointer hover:bg-blue-100 transition-colors duration-100 ease-in p-2">
                  ...
                  <section className="message-two flex items-center gap-x-3 my-4 cursor-pointer hover:bg-blue-100 transition-colors duration-100 ease-in p-2">
                  ...
                  <section className="message-three flex items-center gap-x-3 my-4 cursor-pointer hover:bg-blue-100 transition-colors duration-100 ease-in p-2">
                    <div className="avatar online">
                      <div className="w-14 rounded-full">
